...
export async function POST(request: NextRequest) {
  ...
  // Whitelist fields only — never trust client-supplied recorded_by or id
  const payload = {
    ...
    vendor: typeof body.vendor === "string" ? body.vendor.trim().slice(0, 200) : null,
    reference: typeof body.reference === "string" ? body.reference.trim().slice(0, 100) : null,
    receipt_url: typeof body.receipt_url === "string" ? body.receipt_url.trim() : null,
