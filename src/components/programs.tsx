...
const programs = [
  {
    ...
    icon: Baby,
    description: "Un accompagnement doux et personnalisé pour les premières années de votre enfant.",
    items: ["Soins personnalisés", "Éveil sensoriel", "Développement moteur", "Repos et confort"],
  ...
  },
  {
    ...
    icon: GraduationCap,
    description: "Un environnement stimulant pour apprendre, créer et développer son autonomie.",
    items: ["Développement du langage", "Premiers apprentissages", "Arts et créativité", "Socialisation"],
          ...
          {programs.map((program) => {
            ...
            return (
              <StaggerItem key={program.title}>
                <div className="group grid overflow-hidden rounded-[24px] border border-slate-100 bg-white shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-xl sm:grid-cols-[0.8fr_1.2fr]">
