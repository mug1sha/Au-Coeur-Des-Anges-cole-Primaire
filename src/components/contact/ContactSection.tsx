...
export default function ContactSection() {
  ...
  const inputClass = (field: keyof typeof initialForm) =>
    `w-full rounded-[12px] border px-4 py-3 text-sm text-[#0B1B3D] outline-none transition focus:ring-2 focus:ring-[#FF6B35]/30 ${
      errors[field]
        ? "border-red-400 bg-red-50"
        : "border-slate-200 bg-white focus:border-[#FF6B35]"
    }`;
        ...
        <div className="grid gap-10 lg:grid-cols-[380px_1fr]">
          ...
          <div className="space-y-6">
                  ...
                  return (
                    <div key={item.label} className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="mt-0.5 text-sm font-medium text-white/90 whitespace-pre-line">{item.value}</p>
                      </div>
                    </div>
                  );
                })}
            ...
            <a
              ...
              className="flex w-full items-center justify-center gap-3 rounded-[16px] bg-[#25D366] px-5 py-4 text-sm font-bold text-white transition hover:-translate-y-0.5 hover:bg-[#22c05e] hover:shadow-lg"
            >
          ...
          <div>
            <div className="rounded-[24px] border border-slate-100 bg-white p-7 shadow-[0_8px_40px_rgba(11,27,61,0.06)] sm:p-8">
              <h2 className="font-[family-name:var(--font-heading)] text-2xl font-extrabold text-[#0B1B3D]">
                Envoyer un message
              </h2>
              <p className="mt-2 text-sm text-[#0B1B3D]/55">
                Remplissez le formulaire ci-dessous, nous vous répondrons rapidement.
              </p>

              {state === "success" ? (
                <div className="mt-8 flex flex-col items-center justify-center gap-4 rounded-[16px] bg-green-50 p-10 text-center">
                  ...
                  <p className="text-sm text-[#0B1B3D]/60">
                ...
                <form onSubmit={handleSubmit} noValidate className="mt-7 space-y-5">
                  <div className="grid gap-5 sm:grid-cols-2">
                    <div>
                      <label htmlFor="nom" className="mb-1.5 block text-xs font-semibold text-[#0B1B3D]">
                      ...
                      />
                      {errors.nom && (
                        <p id="nom-error" role="alert" className="mt-1 flex items-center gap-1 text-xs text-red-500">
                    ...
                    <div>
                      <label htmlFor="email" className="mb-1.5 block text-xs font-semibold text-[#0B1B3D]">
                  ...
                  <div className="grid gap-5 sm:grid-cols-2">
                    <div>
                      <label htmlFor="telephone" className="mb-1.5 block text-xs font-semibold text-[#0B1B3D]">
                        Téléphone
                      </label>
                      <input
                        id="telephone"
                    ...
                    <div>
                      <label htmlFor="service" className="mb-1.5 block text-xs font-semibold text-[#0B1B3D]">
                        Service souhaité
                      </label>
                      <select
                        id="service"
                  ...
                  <div className="grid gap-5 sm:grid-cols-2">
                    <div>
                      <label htmlFor="enfant" className="mb-1.5 block text-xs font-semibold text-[#0B1B3D]">
                        Nom de l&apos;enfant
                      </label>
                      <input
                        id="enfant"
                        ...
                        className={inputClass("enfant")}
                      />
                    </div>

                    <div>
                      <label htmlFor="age" className="mb-1.5 block text-xs font-semibold text-[#0B1B3D]">
                        Âge de l&apos;enfant
                      </label>
                      <input
                        id="age"
                  ...
                  <div>
                    <label htmlFor="message" className="mb-1.5 block text-xs font-semibold text-[#0B1B3D]">
                  ...
                  {state === "error" && (
                    <p className="flex items-center gap-2 rounded-[10px] bg-red-50 px-4 py-3 text-sm text-red-600">
                      <AlertCircle size={15} />
                  ...
                  <button
                    ...
                    className="flex w-full items-center justify-center gap-2 rounded-[14px] bg-[#FF6B35] px-6 py-3.5 text-sm font-bold text-white shadow-md transition duration-200 hover:-translate-y-0.5 hover:bg-[#F95738] hover:shadow-xl disabled:cursor-not-allowed disabled:opacity-60"
                  >
                    {state === "loading" ? (
