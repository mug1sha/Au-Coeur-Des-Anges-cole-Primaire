    ...
    <section className="relative py-20 lg:py-28 bg-white overflow-hidden">
      <div ref={ref} className="relative z-10">
        ...
        <motion.div
          ...
          className="relative rounded-[16px] overflow-hidden bg-offwhite border border-lightgray"
        >
          <div className="aspect-[16/7] flex flex-col items-center justify-center p-8 text-center">
            {/* Map icon */}
            <div className="w-20 h-20 rounded-[10px] bg-navy/5 flex items-center justify-center mb-6">
