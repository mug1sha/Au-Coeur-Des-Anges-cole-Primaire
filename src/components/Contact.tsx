  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden" aria-hidden="true">
        <svg
          className="absolute -top-20 -right-20 w-[450px] h-[450px] opacity-[0.05]"
          viewBox="0 0 200 200"
            ...
            <div className="bg-navy rounded-3xl p-8 lg:p-10 overflow-hidden relative">
              ...
              <div className="relative z-10">
                ...
                <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                  ...
                  <button
                    type="submit"
                    className="w-full py-3.5 bg-orange text-white font-heading font-semibold rounded-xl hover:bg-orange-light transition-all duration-300 hover:shadow-lg hover:shadow-orange/25 focus-visible:outline focus-visible:outline-2 focus-visible:outline-white focus-visible:outline-offset-2"
                  >
                    Envoyer la demande
                  </button>
                </form>
