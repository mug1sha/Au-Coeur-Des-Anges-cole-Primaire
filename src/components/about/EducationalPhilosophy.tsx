  ...
  return (
    <section className="relative py-20 lg:py-28 bg-offwhite overflow-hidden">
      ...
      <Container className="relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-5">
          {pillars.map((pillar, i) => (
            <motion.div
              ...
              className="group relative flex gap-5 p-6 rounded-2xl bg-white transition-all duration-300 hover:shadow-card-hover hover:-translate-y-1"
            >
              {/* Icon */}
        ...
        >
          <div className="relative flex items-center gap-4 px-8 py-4 bg-white rounded-2xl shadow-sm">
            <div className="text-center">
              <div className="w-10 h-10 rounded-xl bg-blue/10 flex items-center justify-center mx-auto mb-1">
            ...
            <div className="text-center">
              <div className="w-10 h-10 rounded-xl bg-orange/10 flex items-center justify-center mx-auto mb-1">
            ...
            <div className="text-center">
              <div className="w-10 h-10 rounded-xl bg-navy/10 flex items-center justify-center mx-auto mb-1">
