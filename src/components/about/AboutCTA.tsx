          ...
          <div className="relative z-10 px-8 py-16 md:px-16 md:py-20 lg:px-24 lg:py-24 text-center">
            ...
            >
              ...
              <span className="relative inline-block">
                <span className="relative z-10 text-orange">environnement scolaire</span>
            ...
            >
              Venez visiter notre école, rencontrer notre équipe et découvrir
              l&apos;environnement dans lequel vos enfants apprendront et
              grandiront.
            </motion.p>
