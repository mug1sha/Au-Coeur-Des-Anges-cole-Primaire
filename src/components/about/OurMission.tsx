        ...
        <div ref={ref} className="max-w-4xl mx-auto text-center">
          ...
          >
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-[5px] bg-orange/10 flex items-center justify-center" aria-hidden="true">
            ...
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-[5px] bg-blue/10 flex items-center justify-center" aria-hidden="true">
            ...
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-[5px] bg-navy/10 flex items-center justify-center" aria-hidden="true">
