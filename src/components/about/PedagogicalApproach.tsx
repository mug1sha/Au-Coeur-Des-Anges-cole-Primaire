      ...
      <div className="mx-auto grid max-w-[1200px] items-center gap-14 lg:grid-cols-2 lg:gap-20">
        ...
        <div>
          ...
          <p className="mt-5 leading-7 text-[#0B1B3D]/65">
            Notre pédagogie s&apos;appuie sur les dernières recherches en sciences de
            l&apos;éducation. Nous privilégions une approche globale qui prend en
            compte le développement cognitif, émotionnel et social de chaque
            enfant.
          </p>

          <ul className="mt-7 space-y-3">
            {approaches.map((item) => (
              <li key={item} className="flex items-center gap-3 text-[#0B1B3D]/80">
