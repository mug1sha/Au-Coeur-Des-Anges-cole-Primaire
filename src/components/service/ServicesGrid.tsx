...
const services = [
  ...
  },
  {
    icon: (
      <svg viewBox="0 0 48 48" fill="none" className="w-10 h-10" aria-hidden="true">
        ...
        <circle cx="24" cy="18" r="6" fill="#FF6B35" />
        <path d="M14 36 C14 30 18 26 24 26 C30 26 34 30 34 36" fill="#FF6B35" opacity="0.6" />
      </svg>
    ),
  ...
  },
  {
    icon: (
      <svg viewBox="0 0 48 48" fill="none" className="w-10 h-10" aria-hidden="true">
        <circle cx="24" cy="24" r="22" fill="#FF6B35" opacity="0.1" />
        <rect x="14" y="14" width="20" height="20" rx="3" fill="#FF6B35" opacity="0.15" />
        <path d="M18 28 L18 22 M22 28 L22 18 M26 28 L26 22 M30 28 L30 20" stroke="#FF6B35" strokeWidth="2" strokeLinecap="round" />
      </svg>
    ),
        ...
        <div className="text-center max-w-2xl mx-auto mb-16 lg:mb-20">
          ...
          >
            ...
            <span className="relative inline-block">
              ...
              <span className="absolute bottom-1 left-0 right-0 h-3 bg-blue/10 -rotate-1 rounded-full" />
            </span>{" "}
            pour chaque famille
          </motion.h2>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5">
          {services.map((service, i) => (
            <motion.article
              ...
              className="group relative p-6 rounded-[16px] bg-offwhite/50 hover:bg-white transition-colors duration-300 card-hover"
            >
              {/* Icon */}
