...
const activities = [
  {
    icon: Music,
    title: "Éveil Musical",
    description: "Chants, rythmes et instruments pour éveiller la sensibilité artistique.",
  },
  {
    icon: Scissors,
    title: "Arts & Bricolage",
    description: "Travaux manuels créatifs qui développent la motricité fine.",
  },
  {
    icon: Palette,
    title: "Activités Créatives",
    description: "Peinture, dessin et expression libre pour stimuler l'imagination.",
  },
  {
    icon: BookOpen,
    title: "Jeux Éducatifs",
    description: "Jeux pédagogiques adaptés pour apprendre en s'amusant.",
  },
  {
    icon: MessageSquare,
    title: "Développement du Langage",
    description: "Histoires, poésies et conversations pour enrichir le vocabulaire.",
  },
  {
    icon: Bike,
    title: "Activités Motrices",
    description: "Jeux de mouvement et exercices physiques adaptés à chaque âge.",
  },
];
