...
const values = [
  ...
  },
  {
    icon: (
      <svg viewBox="0 0 48 48" fill="none" className="w-8 h-8" aria-hidden="true">
        <path d="M24 14 C24 14 16 18 16 24 C16 28.4 19.6 32 24 32 C28.4 32 32 28.4 32 24 C32 18 24 14 24 14Z" fill="#023250" opacity="0.7" />
  ...
  },
  {
    icon: (
      <svg viewBox="0 0 48 48" fill="none" className="w-8 h-8" aria-hidden="true">
        <circle cx="24" cy="20" r="6" fill="#FF7800" opacity="0.3" />
        <path d="M18 28 C18 28 20 32 24 32 C28 32 30 28 30 28" stroke="#FF7800" strokeWidth="2" strokeLinecap="round" />
        <path d="M24 14 L24 10 M30 16 L33 13 M18 16 L15 13" stroke="#FF7800" strokeWidth="1.5" strokeLinecap="round" />
      </svg>
    ),
    title: "Curiosite",
  ...
  },
  {
    icon: (
      <svg viewBox="0 0 48 48" fill="none" className="w-8 h-8" aria-hidden="true">
        <path d="M24 10 L27 18 L35 19 L29 25 L30.5 33 L24 29 L17.5 33 L19 25 L13 19 L21 18 Z" fill="#023250" opacity="0.7" />
