            ...
            <div className="flex gap-3 mt-5">
              {[
                ...
                <a
                  key={social.name}
                  href="#"
                  className="w-9 h-9 rounded-[5px] bg-white/[0.06] flex items-center justify-center text-white/40 hover:bg-orange/20 hover:text-orange transition-all duration-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-orange focus-visible:outline-offset-2"
