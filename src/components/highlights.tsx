      ...
      <div className="mx-auto grid max-w-[1200px] gap-4 md:grid-cols-3">
        ...
        {highlights.map((item) => {
          ...
          return (
            <div
              key={item.title}
              className="group flex items-center gap-4 rounded-[18px] border border-slate-100 bg-white p-5 shadow-[0_10px_40px_rgba(11,27,61,0.08)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_15px_45px_rgba(11,27,61,0.12)]"
            >
